          ...
          >
            ...
            <ul className={css.container}>
              <li>
                ...
                <div style={{ maxWidth: "100%" }} id={2} onClick={runGame}>
                  <StepByStepButton name="2" dataSvg={svgBagOneStar} />
                </div>
                <div style={{ maxWidth: "100%" }} id={3} onClick={runGame}>
                  <StepByStepButton name="3" dataSvg={svgBagTwoStars} />
                </div>
                <div style={{ maxWidth: "100%" }} id={4} onClick={runGame}>
              ...
              <li>
                ...
                <div style={{ maxWidth: "100%" }} id={7} onClick={runGame}>
              ...
              <li>
                ...
                <div style={{ maxWidth: "100%" }} id={9} onClick={runGame}>
                  <StepByStepButton name="9" dataSvg={svgBagOneStar} />
                </div>
                <div style={{ maxWidth: "100%" }} id={10} onClick={runGame}>
              ...
              <li>
                ...
                <div style={{ maxWidth: "100%" }} id={12} onClick={runGame}>
                  <StepByStepButton name="12" dataSvg={svgBagOneStar} />
                </div>
                <div style={{ maxWidth: "100%" }} id={13} onClick={runGame}>
                  <StepByStepButton name="13" dataSvg={svgQuestionTwoStars} />
                </div>
                <div id={14} onClick={runGame}>
              ...
              <li>
                ...
                <div style={{ maxWidth: "100%" }} id={16} onClick={runGame}>
